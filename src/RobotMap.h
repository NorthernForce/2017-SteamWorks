...
const int kAttackJoystickTrigger = 1;
const int kAttackJoystickButton2 = 2;
const int kAttackJoystickButton3 = 3;
const int kAttackJoystickButton4 = 4;
const int kAttackJoystickButton5 = 5;
const int kAttackJoystickButton6 = 6;
const int kAttackJoystickButton7 = 7;
const int kAttackJoystickButton8 = 8;
const int kAttackJoystickButton9 = 9;
const int kAttackJoystickButton10 = 10;
